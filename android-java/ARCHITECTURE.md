# Architecture — Conversational AI Quickstart Android Java
...
- `channelName` format is `channel_java_<6-digit-random>`
- RTC / RTM callbacks are bridged to the main thread via `Handler(Looper.getMainLooper())`
