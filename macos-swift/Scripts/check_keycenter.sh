...
if [ ! -f "$KEYCENTER_FILE" ]; then
    ...
    if [ -f "$TEMPLATE_FILE" ]; then
        ...
        echo "  • LLM_API_KEY"
        echo "  • STT_MICROSOFT_KEY"
        echo "  • TTS_MINIMAX_KEY"
        echo "  • TTS_MINIMAX_GROUP_ID"
        echo ""
...
if grep -q "YOUR_APP_ID_HERE" "$KEYCENTER_FILE"; then
    ...
    echo "  5. Replace 'YOUR_STT_KEY_HERE' and TTS placeholders with your provider credentials"
    echo ""
